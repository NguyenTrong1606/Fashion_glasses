...
//                 `https://itnews-api.herokuapp.com/api/v1/post/${id_post}/comment`,
//                 { content }
//             )
//             if (response.status === 200) {
//                 return await { ...response.data, status: response.status }
...
//         try {
//             const response = await axios.post(
//                 `https://itnews-api.herokuapp.com/api/v1/post/${id_post}/comment/${id_cmt_parent}/reply`,
//                 { content }
//             )
//             if (response.status === 200) {
//                 return await { ...response.data, status: response.status }
...
//                 `https://itnews-api.herokuapp.com/api/v1/post/${id_post}/comment/${id_cmt}/delete`
//             )
//             if (response.status === 200) {
//                 return await {
//                     ...response.data,
...
//                 `https://itnews-api.herokuapp.com/api/v1/post/${id_post}/comment/${id_cmt}/update`,
//                 { content }
//             )
//             if (response.status === 200) {
//                 return await { ...response.data, status: response.status }
